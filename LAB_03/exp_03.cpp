...
{
    long inputsize[3]={1000000,10000000,100000000};
  for(int it=0; it<3;it++){
     cout<<"\n Input size ="<<inputsize[it]<<endl;
        long count1 =CacheUnfriendlySieve(inputsize[it]);
  	cout<<"Unfriendly "<<count1<<" | ";
        cout<< "Time : "<<t<<endl;

        long count2 = CacheFriendlySieve(inputsize[it]);	
	cout<<"Friendly "<<count2<<" | ";
	cout<< "Time : "<<t<<endl;

        long count3 = ParallelSieve(inputsize[it]);	
